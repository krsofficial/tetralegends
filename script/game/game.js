...
//    }
  ...
  resize() {
    ...
    for (const element of [
	  ...
	  {
	  game[element].width = (game[element].clientWidth * game.cellSizeRatio) / (game.cellSizeRatio * game.cellSizeRatio)
      game[element].height = (game[element].clientHeight * game.cellSizeRatio) / (game.cellSizeRatio * game.cellSizeRatio)
	  } else {
